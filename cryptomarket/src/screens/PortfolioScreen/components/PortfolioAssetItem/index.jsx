...
const PortfolioAssetItem=({ assetItem }) =>{
   ...
   // console.log(assetItem);    console.log("price" +currentPrice);
    console.log("percentage" +priceChangePercentage);
        ...
        <View style={styles.coinContainer}>
            ...
            <View style={{marginLeft:'auto',alignItems:'flex-end'}}>
                ...
                <View style={{flexDirection:'row'}}>
                    ...
                    />
                    <Text style={{color: isChangePositive() ? "#16c784" : "#ea3943",fontWeight:'700'}}> %{priceChangePercentage.toFixed(2)}</Text>
                </View>
            </View>
